(custom-set-variables
 ...
 '(package-selected-packages
   '(with-editor hcl-mode htmlize quickrun tramp projectile helm flycheck exec-path-from-shell web-mode kotlin-mode groovy-mode nginx-mode markdown-mode terraform-mode docker-compose-mode dockerfile-mode js2-mode vue3-mode ag find-file-in-repository magit php-mode yaml-mode))
 '(save-place t)
 '(scroll-bar-mode nil)
 '(standard-indent 2)
